      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4">
              {product.images.map((img, i) => (
                <div key={i} className="relative aspect-square bg-surface cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="space-y-4">
              <h4 className="text-[11px] font-black uppercase tracking-widest">{t.color}: {selectedColor}</h4>
            ...
            <div className="pt-10 border-t border-gray-100 space-y-6">
              {[
                { id: "features", title: t.specifications, content: product.features },
